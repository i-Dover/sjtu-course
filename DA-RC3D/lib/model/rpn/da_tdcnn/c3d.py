...
import torch
from lib.model.da_tdcnn.tdcnn import _TDCNN
import math
...
class C3D(nn.Module):
    ...
    The C3D network as described in [1].
        References
        ----------
       [1] Tran, Du, et al. "Learning spatio temporal features with 3d convolutional networks."
...
class c3d_tdcnn(_TDCNN):
    def __init__(self, pretrained=False):
        self.model_path = 'data/pretrained_model/ucf101-caffe.pth' #ucf101-caffe.pth' #c3d_sports1M.pth' #activitynet_iter_30000_3fps-caffe.pth
