...
from model.da_tdcnn.LabelResizeLayer import ImageLabelResizeLayer
from model.da_tdcnn.LabelResizeLayer import InstanceLabelResizeLayer
...
class _ImageDA(nn.Module):
    def __init__(self,dim):
        ...
        self.Conv1 = nn.Conv3d(self.dim, 512, kernel_size=(1, 1, 1), stride=(1, 1, 1),bias=False)
        self.Conv2=nn.Conv3d(512,2,kernel_size=(1, 1, 1), stride=(1, 1, 1),bias=False)
