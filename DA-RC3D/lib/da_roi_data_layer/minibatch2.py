...
def _get_video_blob(roidb, scale_inds, phase='train'):
    ...
    for i, item in enumerate(roidb):
        ...
        frame_d = 'preprocess/thumos14'
        prefix = os.path.join(frame_d, prefix)
        ...
        for i, idx in enumerate(range(video_info[1], video_info[2], step)):
            ...
            frame = prep_im_for_blob(frame, cfg.PIXEL_MEANS, tuple(cfg.TRAIN.FRAME_SIZE[::-1]), cfg.TRAIN.CROP_SIZE,
                                     random_idx)
